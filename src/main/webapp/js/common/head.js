...
document.writeln("							<li>");
document.writeln("								<a href=\'cover.html\'>封面</a>");
document.writeln("							</li>");
document.writeln("							<li>");
...
document.writeln("					<li><button type=\'button\' class=\'btn btn-default navbar-btn\' onclick=\'location.href=\"login.html\"\'>登录</button></li>");
document.writeln("					<li><button type=\'button\' class=\'btn btn-default navbar-btn\' onclick=\"location.href=\'register.html\'\">注册</button></li>");
document.writeln("");
document.writeln("				</ul>");
document.writeln("			</div>");
